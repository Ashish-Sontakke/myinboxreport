    ...
    visual: (
      <div className="space-y-3">
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground pt-2 border-t border-dashed">
          ...
          <span className="font-semibold text-foreground">$38.97 due</span>
        </div>
      </div>
    ),
  },
    ...
    visual: (
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-2 text-[11px]">
          {["Payroll Inc", "Stripe Payout", "Refunds"].map((src) => (
            <span
              key={src}
    ...
    visual: (
      <div className="space-y-3">
        {[
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold">{newsletter.name}</p>
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground pt-2 border-t border-dashed">
          ...
          <span className="font-semibold text-foreground">0 sent</span>
        </div>
      </div>
    ),
  },
      ...
      <section className="relative overflow-hidden pt-24 pb-20 md:pt-32 md:pb-28">
        <div className="container px-4 mx-auto">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto space-y-8">
            <Badge
              variant="outline"
              className="p-4 text-sm rounded-full border-primary/20 bg-primary/5 text-primary animate-in fade-in slide-in-from-bottom-4 duration-1000"
            >
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button
                size="lg"
                variant="secondary"
                render={<Link href={siteConfig.links.github} />}
              >
                Star on GitHub
              </Button>
            </div>
